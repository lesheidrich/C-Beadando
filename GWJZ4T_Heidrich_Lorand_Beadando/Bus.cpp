...
double Bus::calculateCost()
{
    ...
    return kmDelta() * getPricePerKm() + getDaysOut() * getPricePerDay() + insuranceCostPerPerson_m * CurrentPassengers();
}
...
void Bus::printQuote()
{
    ...
    cout << "  Insurance/passenger:\t$ " << fixed << setprecision(2) << insuranceCostPerPerson_m << endl;
    cout << "+----------------------------------+\n" << endl;
}
